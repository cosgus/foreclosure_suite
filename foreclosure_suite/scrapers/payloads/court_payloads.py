...
class CourtPayloads:
    ...
    def set_court_form(self, view_state:str, event_validation:str, case_number:str = None):
        """
        ...
        """
        self.court_form['__VIEWSTATE'] = view_state
        self.court_form['__EVENTVALIDATION'] = event_validation
        self.court_form['ctl00$ContentPlaceHolder1$txtLCNYearSTD_localCaseContent'] = case_number[0:4]
        self.court_form['ctl00$ContentPlaceHolder1$txtLCNSeqSTD_localCaseContent'] = case_number[4:10]
        self.court_form['ctl00$ContentPlaceHolder1$localCaseCodesSelect_localCaseContent'] = case_number[10:12]
        self.court_form['ctl00$ContentPlaceHolder1$txtLCNLocSTD_localCaseContent'] = '01'

    def set_login_form(self, view_state:str, event_validation: str) -> None:
        self.login['__VIEWSTATE'] = view_state
        self.login['__EVENTVALIDATION'] = event_validation
